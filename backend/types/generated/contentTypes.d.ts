...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Hero and about-me content';
    displayName: 'About';
    pluralName: 'abouts';
    singularName: 'about';
  };
  ...
  attributes: {
    ...
    leetcodeUsername: Schema.Attribute.String;
...
export interface ApiEducationEducation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    scoreType: Schema.Attribute.Enumeration<['Grade', 'Percentage', 'CGPA']> &
      Schema.Attribute.DefaultTo<'CGPA'>;
...
export interface ApiExperienceExperience extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    skillsDeveloped: Schema.Attribute.Text;
    startDate: Schema.Attribute.Date;
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['Technical', 'Soft']> &
